        ...
        <div className="container px-4 relative z-10">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-8">
            ...
            <form onSubmit={handleSearch} className="w-full max-w-2xl mt-4">
              <div className="relative flex items-center h-14 md:h-16 rounded-full border border-border bg-card shadow-lg transition-all duration-300 focus-within:shadow-[0_0_20px_hsl(var(--primary)/0.2)] focus-within:border-primary">
                <input
                  type="text"
