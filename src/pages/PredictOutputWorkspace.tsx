 ...
 * Visually matches the ProblemDetail (Solve) workspace layout.
 */
...
export default function PredictOutputWorkspace() {
  ...
  // Fetch all problems in this skill (both types)
  ...
  // Calculate prev/next — navigate to correct route based on problem type
  ...
  const nextProblem =
    currentIndex < allProblemsInSkill.length - 1 ? allProblemsInSkill[currentIndex + 1] : null;
  ...
  // Top nav bar (shared between normal/expanded)
  const topNav = (
