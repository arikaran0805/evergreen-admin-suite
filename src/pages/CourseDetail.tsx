                                                ...
                                                <DropdownMenu>
                                                  ...
                                                  <DropdownMenuContent align="end" className="w-48" onClick={(e) => e.stopPropagation()}>
                                                    <DropdownMenuItem
                                                      onClick={(e) => {
                                                        e.stopPropagation();
                                                        const shareUrl = `${window.location.origin}/courses/${post.slug}`;
                                                        window.open(`https://wa.me/?text=${encodeURIComponent(post.title + ' ' + shareUrl)}`, '_blank');
                                                        trackPostShare(post.id, 'whatsapp');
                                                      }}
                                                    >
                                                    ...
                                                    <DropdownMenuItem
                                                      onClick={(e) => {
                                                        ...
                                                        trackPostShare(post.id, 'linkedin');
                                                      }}
                                                    >
                                                    ...
                                                    <DropdownMenuItem
                                                      onClick={(e) => {
                                                        ...
                                                        trackPostShare(post.id, 'instagram');
                                                      }}
                                                    >
                                                      <svg className="h-4 w-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <DropdownMenuItem
                                                      onClick={(e) => {
                                                        ...
                                                        navigator.clipboard.writeText(shareUrl);
                                                        toast({ title: "Link copied!" });
                                                        trackPostShare(post.id, 'copy_link');
                                                      }}
                                                    >
